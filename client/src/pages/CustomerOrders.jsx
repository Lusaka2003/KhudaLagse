        ...
        <div className="mb-12">
            ...
            {upcomingOrders.length > 0 ? (
                ...
                <div className="bg-white rounded-2xl border border-stone-200 p-8 text-center">
                    ...
                    <Link to="/restaurants" className="inline-block mt-4 text-violet-600 font-bold hover:underline">Browse Kitchens →</Link>
                </div>
            )}
        </div>
...
const OrderCard = ({ order, isUpcoming, cancelOrder, updatingId, fetchTracking, tracking, formatDeliveryAddress, userAddress, onRateDriver }) => {
    ...
    return (
        <div className={`bg-white rounded-2xl border ${isUpcoming ? 'border-violet-100 shadow-lg shadow-violet-50' : 'border-stone-200'} overflow-hidden transition-all hover:shadow-md`}>
            {/* Header */}
            ...
            <div className="p-4 sm:p-6 grid md:grid-cols-2 gap-6">
                <div>
                     ...
                     <div className="mt-4 pt-4 border-t border-stone-100 flex justify-between items-center">
                        ...
                        <span className="font-bold text-violet-600 text-lg">{order.total} ৳</span>
                     </div>
                </div>
